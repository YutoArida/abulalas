...
class portalController extends DBController
{
    ...
    {
        $query = "SELECT * FROM tbl_school_student_record TSSR LEFT JOIN  tbl_user_information TUI ON TSSR.uid = TUI.uid LEFT JOIN  tbl_school_year_details_grade TSYDG ON TSSR.current_level = TSYDG.gid LEFT JOIN tbl_school_year_details_section TSYDS ON TSSR.current_section = TSYDS.sid WHERE TSSR.sycode IN (SELECT TUSSY.sycode FROM tbl_user_school_year TUSSY WHERE TUSSY.status = 'ACTIVATED')";
    ...
    function myAttendanceMonitoringTodayTeacher($sid)
    {
        ...
        $query = "SELECT * FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id LEFT JOIN tbl_school_student_record TSSR ON TSMA.uid = TSSR.uid WHERE TSSR.current_section = ? AND DATE(TSMA.date_inserted) = CURDATE() AND TSYDM.room != 'CLINIC' AND TSYDM.room != 'CANTEEN' AND TSYDM.room != 'ICT' AND TSYDM.room != 'LIBRARY' AND TSYDM.room != 'OFFICE' AND TSYDM.room != 'CONFERENCE ROOM'"; 
    ...
    {
        date_default_timezone_get('Asia/Manila');
        $query = "SELECT * FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id WHERE TSMA.uid = ? AND DATE(TSMA.date_inserted) = CURDATE() AND TSYDM.room != 'CLINIC' AND TSYDM.room != 'CANTEEN' AND TSYDM.room != 'ICT' AND TSYDM.room != 'LIBRARY' AND TSYDM.room != 'OFFICE' AND TSYDM.room != 'CONFERENCE ROOM' GROUP BY TSMA.date_inserted"; 
    ...
    {
        date_default_timezone_get('Asia/Manila');
        $query = "SELECT * FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id WHERE TSMA.uid = ? AND YEARWEEK(TSMA.date_inserted) = YEARWEEK(CURDATE()) GROUP BY TSMA.date_inserted"; 
    ...
    function myAttendanceMonitorinMonthlyGroup($uid)
    {
        ...
        WHERE TSMA.uid = ? 
          ...
          AND MONTH(TSMA.date_inserted) = MONTH(CURDATE()) GROUP BY TSMA.date_inserted
        "; 
    ...
    {
        date_default_timezone_get('Asia/Manila');
        $query = "SELECT * FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id LEFT JOIN tbl_school_student_record TSSR ON TSMA.uid = TSSR.uid WHERE TSSR.current_section = ? AND TSYDM.room != 'CLINIC' AND TSYDM.room != 'CANTEEN' AND TSYDM.room != 'ICT' AND TSYDM.room != 'LIBRARY' AND TSYDM.room != 'OFFICE' AND TSYDM.room != 'CONFERENCE ROOM'"; 
    ...
    function myAttendanceMonitoringOverallNoSpecificMonthly()
    {
        ...
        $query = "SELECT *,
        MONTH(TSMA.date_inserted) AS current_month FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id LEFT JOIN tbl_school_student_record TSSR ON TSMA.uid = TSSR.uid LEFT JOIN tbl_school_year_details_grade TSYDG ON TSSR.current_level = TSYDG.gid LEFT JOIN tbl_school_year_details_section TSYDS ON TSSR.current_section = TSYDS.sid WHERE TSSR.sycode IN (SELECT TUSSY.sycode FROM tbl_user_school_year TUSSY WHERE TUSSY.status = 'ACTIVATED') AND MONTH(TSMA.date_inserted) = MONTH(CURDATE())";
    ...
    function myAttendanceMonitoringOverallNoSpecific()
    {
        ...
        $query = "SELECT *, WEEK(TSMA.date_inserted) AS current_week FROM tbl_school_monitoring_attendance TSMA LEFT JOIN tbl_school_year_details_map TSYDM ON TSMA.room = TSYDM.id LEFT JOIN tbl_school_student_record TSSR ON TSMA.uid = TSSR.uid LEFT JOIN tbl_school_year_details_grade TSYDG ON TSSR.current_level = TSYDG.gid LEFT JOIN tbl_school_year_details_section TSYDS ON TSSR.current_section = TSYDS.sid WHERE TSSR.sycode IN (SELECT TUSSY.sycode FROM tbl_user_school_year TUSSY WHERE TUSSY.status = 'ACTIVATED') AND WEEK(TSMA.date_inserted) = WEEK(CURDATE())";
    ...
    function myAttendanceMonitoringOverallNoSpecificSearchable($gid, $sid)
    {
        ...
        AND TSSR.sycode IN (SELECT TUSSY.sycode FROM tbl_user_school_year TUSSY WHERE TUSSY.status = 'ACTIVATED') AND WEEK(TSMA.date_inserted) = WEEK(CURDATE());";
            $params = array(
   ...
   AND MONTH(TSMA.date_inserted) = MONTH(CURDATE());";
    ...
    function myTeacherStudent($sid, $gid)
    {
        ...
        WHERE TSSR.current_section = ? AND TSSR.current_level = ?"; 
