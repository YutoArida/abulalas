                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-announcement" role="tabpanel" aria-labelledby="pills-announcement-tab">
                                    ...
                                    <hr />
                                    <div class="row">
                                        <table id="myAnnouncementTable" class="table table-striped w-100" style="text-align:center;">
                                            <thead>
                                                 <tr>
                                ...
                                <div class="tab-pane fade" id="pills-archive" role="tabpanel" aria-labelledby="pills-archive-tab">
                                    ...
                                    <hr />
                                    <div class="row">
                                        <table id="myInactiveAnnouncementTable" class="table table-striped w-100" style="text-align:center;">
                                            <thead>
                                                 <tr>
                                                    <th scope="col">TITLE</th>
                                                    <th scope="col">DETAILS</th>
