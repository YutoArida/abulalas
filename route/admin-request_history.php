                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            ?>
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="heading<?php echo $value['reqhid']; ?>">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#collapse<?php echo $value['reqhid']; ?>" aria-expanded="true"
                                                    aria-controls="collapse<?php echo $value['reqhid']; ?>">
                                                    <?php echo $value['date_added']; ?>
                                                </button>
                                            </h2>
                                            <div id="collapse<?php echo $value['reqhid']; ?>" class="accordion-collapse collapse show"
                                                aria-labelledby="heading<?php echo $value['reqhid']; ?>" data-bs-parent="#accordionExample">
